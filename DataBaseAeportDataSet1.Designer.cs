...
namespace Aeroport {
    ...
    public partial class DataBaseAeportDataSet1 : global::System.Data.DataSet {
        ...
        public partial class InformationDataTable : global::System.Data.TypedTableBase<InformationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public InformationRow AddInformationRow(string Familia, string Name, string Otchestvo, string Document, string Grazdanstvo, string Compania, string Class, string StrOtpr, string DateTime, string StrPrib) {
...
namespace Aeroport.DataBaseAeportDataSet1TableAdapters {
    ...
    public partial class InformationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Information] ([Familia], [Name], [Otchestvo], [Document], [Grazdanstvo], [Compania], [Class], [StrOtpr], [DateTime], [StrPrib]) VALUES (@Familia, @Name, @Otchestvo, @Document, @Grazdanstvo, @Compania, @Class, @StrOtpr, @DateTime, @StrPrib);
SELECT Id, Familia, Name, Otchestvo, Document, Grazdanstvo, Compania, Class, StrOtpr, DateTime, StrPrib FROM Information WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"
                      UPDATE [dbo].[Information] SET [Familia] = @Familia, [Name] = @Name, [Otchestvo] = @Otchestvo, [Document] = @Document, [Grazdanstvo] = @Grazdanstvo, [Compania] = @Compania, [Class] = @Class, [StrOtpr] = @StrOtpr, [DateTime] = @DateTime, [StrPrib] = @StrPrib WHERE (([Id] = @Original_Id) AND ((@IsNull_Familia = 1 AND [Familia] IS NULL) OR ([Familia] = @Original_Familia)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Otchestvo = 1 AND [Otchestvo] IS NULL) OR ([Otchestvo] = @Original_Otchestvo)) AND ((@IsNull_Document = 1 AND [Document] IS NULL) OR ([Document] = @Original_Document)) AND ((@IsNull_Grazdanstvo = 1 AND [Grazdanstvo] IS NULL) OR ([Grazdanstvo] = @Original_Grazdanstvo)) AND ((@IsNull_Compania = 1 AND [Compania] IS NULL) OR ([Compania] = @Original_Compania)) AND ((@IsNull_Class = 1 AND [Class] IS NULL) OR ([Class] = @Original_Class)) AND ((@IsNull_StrOtpr = 1 AND [StrOtpr] IS NULL) OR ([StrOtpr] = @Original_StrOtpr)) AND ((@IsNull_DateTime = 1 AND [DateTime] IS NULL) OR ([DateTime] = @Original_DateTime)) AND ((@IsNull_StrPrib = 1 AND [StrPrib] IS NULL) OR ([StrPrib] = @Original_StrPrib)));
                      SELECT Id, Familia, Name, Otchestvo, Document, Grazdanstvo, Compania, Class, StrOtpr, DateTime, StrPrib FROM Information WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Familia, Name, Otchestvo, Document, Grazdanstvo, Compania, Class, StrO" +
                "tpr, DateTime, StrPrib FROM dbo.Information";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Id, Familia, Name, Otchestvo, Document, Grazdanstvo, Compania, Class, StrO" +
                "tpr, DateTime, StrPrib FROM dbo.Information";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Id, Familia, Name, Otchestvo, Document, Grazdanstvo, Compania, Class, StrO" +
                "tpr, DateTime, StrPrib FROM dbo.Information";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[3] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[3].Connection = this.Connection;
            this._commandCollection[3].CommandText = "SELECT        Id, Familia, Name, Otchestvo, [Document], Grazdanstvo, Compania, Cl" +
                "ass, StrOtpr, DateTime, StrPrib\r\nFROM            Information";
        ...
        public virtual int FillBy(DataBaseAeportDataSet1.InformationDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy1(DataBaseAeportDataSet1.InformationDataTable dataTable) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillBy2(DataBaseAeportDataSet1.InformationDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_Familia, string Original_Name, string Original_Otchestvo, string Original_Document, string Original_Grazdanstvo, string Original_Compania, string Original_Class, string Original_StrOtpr, string Original_DateTime, string Original_StrPrib) {
            ...
            if ((Original_Grazdanstvo == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((string)(Original_Grazdanstvo));
            }
            if ((Original_Compania == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[12].Value = ((string)(Original_Compania));
            }
            ...
            if ((Original_StrOtpr == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[16].Value = ((string)(Original_StrOtpr));
            }
            if ((Original_DateTime == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[18].Value = ((string)(Original_DateTime));
            }
            if ((Original_StrPrib == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[20].Value = ((string)(Original_StrPrib));
            }
        ...
        public virtual int Insert(string Familia, string Name, string Otchestvo, string Document, string Grazdanstvo, string Compania, string Class, string StrOtpr, string DateTime, string StrPrib) {
            if ((Familia == null)) {
            ...
            if ((Grazdanstvo == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(Grazdanstvo));
            }
            if ((Compania == null)) {
                this.Adapter.InsertCommand.Parameters[5].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(Compania));
            }
            if ((Class == null)) {
            ...
            if ((StrOtpr == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[7].Value = ((string)(StrOtpr));
            }
            if ((DateTime == null)) {
            ...
            if ((StrPrib == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[9].Value = ((string)(StrPrib));
            }
        ...
        public virtual int Update(
            ...
            if ((Grazdanstvo == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Grazdanstvo));
            }
            if ((Compania == null)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Compania));
            }
            if ((Class == null)) {
            ...
            if ((StrOtpr == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(StrOtpr));
            }
            if ((DateTime == null)) {
                this.Adapter.UpdateCommand.Parameters[8].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(DateTime));
            }
            if ((StrPrib == null)) {
                this.Adapter.UpdateCommand.Parameters[9].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(StrPrib));
            }
            ...
            if ((Original_Document == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[18].Value = ((string)(Original_Document));
            }
            if ((Original_Grazdanstvo == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[20].Value = ((string)(Original_Grazdanstvo));
            }
            if ((Original_Compania == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((string)(Original_Compania));
            }
            if ((Original_Class == null)) {
            ...
            if ((Original_StrOtpr == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[26].Value = ((string)(Original_StrOtpr));
            }
            if ((Original_DateTime == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[28].Value = ((string)(Original_DateTime));
            }
            if ((Original_StrPrib == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[30].Value = ((string)(Original_StrPrib));
            }
        ...
        public virtual int Update(
                    ...
                    string Original_DateTime, 
                    string Original_StrPrib) {
            return this.Update(Familia, Name, Otchestvo, Document, Grazdanstvo, Compania, Class, StrOtpr, DateTime, StrPrib, Original_Id, Original_Familia, Original_Name, Original_Otchestvo, Original_Document, Original_Grazdanstvo, Original_Compania, Original_Class, Original_StrOtpr, Original_DateTime, Original_StrPrib, Original_Id);
        }
    }
